                        ...
                        <div className="grid gap-2 sm:grid-cols-2">
                          {category.children.map((child) => {
                            ...
                            return (
                              <div
                                key={child.id}
                                className="flex items-center justify-between gap-3 rounded-lg border border-gray-200/60 dark:border-gray-800/60 bg-white dark:bg-gray-900 px-3 py-2"
                              >
                                <span className="text-sm text-gray-800 dark:text-gray-100 truncate">{childName}</span>
                                <button
                                  type="button"
