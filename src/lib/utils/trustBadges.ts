...
function getLocaleFallback(locale: string) {
  if (locale === 'vi') {
    return {
      ...
      community: 'Cộng đồng',
      communityTooltip: 'Được cộng đồng tin cậy',
      expert: 'Chuyên gia',
      expertTooltip: 'Được chuyên gia xem xét',
      outdated: 'Hết hạn',
      outdatedTooltip: 'Thông tin hơn 12 tháng trước',
      verifiedStudent: 'Sinh viên đã xác minh',
      verifiedStudentTooltip: 'Đã xác minh tình trạng sinh viên',
      verifiedWorker: 'Người đi làm đã xác minh',
      verifiedWorkerTooltip: 'Đã xác minh tình trạng việc làm',
      verifiedUser: 'Người dùng đã xác minh',
      verifiedUserTooltip: 'Đã xác minh danh tính',
      expertVisa: 'Chuyên gia visa',
      expertVisaTooltip: 'Chuyên gia visa/xuất nhập cảnh (đã xác minh)',
      expertEmployment: 'Chuyên gia việc làm',
      expertEmploymentTooltip: 'Chuyên gia tuyển dụng/career (đã xác minh)',
      trustedAnswerer: 'Người trả lời đáng tin',
      trustedAnswererTooltip: 'Được cộng đồng đánh giá tin cậy dựa trên đóng góp',
    };
  }
  ...
  if (locale === 'en') {
    return {
      ...
      community: 'Community',
      communityTooltip: 'Trusted by community',
      expert: 'Expert',
      expertTooltip: 'Reviewed by an expert',
      outdated: 'Outdated',
      outdatedTooltip: 'More than 12 months old',
      verifiedStudent: 'Verified Student',
      verifiedStudentTooltip: 'Student status verified',
      verifiedWorker: 'Verified Worker',
      verifiedWorkerTooltip: 'Employment status verified',
      verifiedUser: 'Verified User',
      verifiedUserTooltip: 'Identity verified',
      expertVisa: 'Visa Expert',
      expertVisaTooltip: 'Verified visa/immigration professional',
      expertEmployment: 'Employment Expert',
      expertEmploymentTooltip: 'Verified employment/career professional',
      trustedAnswerer: 'Trusted Answerer',
      trustedAnswererTooltip: 'Trusted by community based on contributions',
    };
  }
